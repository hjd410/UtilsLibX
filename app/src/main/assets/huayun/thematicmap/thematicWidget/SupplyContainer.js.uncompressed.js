define("com/huayun/thematicmap/thematicWidget/SupplyContainer", [
    'require',
    'dojo/_base/declare',
    'dojo/dom',
    'dojo/dom-class',
    ...
    "dojo/text!../widget/templates/power-supply.html"
    ...
    return declare('', [_WidgetBase, _TemplatedMixin, _OnDijitClickMixin],{
        ...
        constructor: function (params) {
            ...
            this.url = "http://10.136.35.108:8082/topo-server/topoCenter/normalServices/supplyArea";
        ...
        onSupplyClose: function() {
            this.domNode.style.display = "none";
            this.restore();
        },

        onSupplyCloseDev: function() {
            this.restore();
        },

        onSupplySelect: function() {
            ...
            this.click = on(this.view.domNode, "click", function(e) {
                ...
                if(result.length > 0) {
                    ...
                    dom.byId("devSelectName").innerHTML = showName;
                    domConstruct.empty(dom.byId("extentShow"));
                    this.delCursor();
                    this.click.remove();
                    this.click = null;
                    ...
                    this._powerFacade.getPowerExtentData(this.url, this.data, function(resp) {
                        if(resp.data !== null && resp.data.length > 0){
                            ...
                            this._powerFacade.getMixtureData(this.mixUrl + "?map_id=" + map_id + "&REL_DEV_ID=" + this.devs, function (data){
                                ...
                                this.view.threeRender();
                                this.treeData = this._treedata.getParentData(this.dicArray.data, this.showMes);
                                ...
                                for(var item in this.treeData) {
                                    ...
                                    on(rootBtn, "click", function(e){
                                        ...
                                        domClass.add(dom.byId("extentShow"), "showScroll");
                                    }.bind(this));
                                }
        ...
        resetDiv: function() {
            dom.byId('devSelectName').innerHTML = "请选择设备";
            domConstruct.empty(dom.byId("extentShow"));
            domClass.remove(dom.byId("extentShow"), "showScroll");
            if(this.heightLight.length > 0) {
                for(var m = 0; m < this.heightLight.length; m++) {
                    this.heightLight[m].glow = null;
                }

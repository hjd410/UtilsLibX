 ...
 */
define("com/huayun/thematicmap/modules/SingleLineMap", [
    "dojo/Deferred",
    "dojo/request",
    "dojo/promise/all",
    "../../webgis/Map",
...
], function (Deferred, request, all, Map, JSONFormatterUtil, SceneView, FeatureLayer, LabelLayer, WKTGeometryFormater) {
    function SingleLineMap(params, backFun) {
        ...
        // this.view.zoomEnd.push(this.zoomEnd.bind(this));
    ...
    SingleLineMap.prototype.createLayer = function (list) {
    ...
    SingleLineMap.prototype.getCurrentRule = function (rule) {
    ...
    SingleLineMap.prototype.update = function (params) {
    ...
    SingleLineMap.prototype.refresh = function () {
        this.view.clear();
        this.list = this.diagramVo.diagramVo.mapVo.layerVoList;
        this.createLayer(this.list);
    };

    SingleLineMap.prototype.clear = function () {
        this.view.clear();
        this.view.threeRender();
    }

    SingleLineMap.prototype.destroy = function () {
        this.view.destroy();
    }

define("com/huayun/thematicmap/modules/SystemMapPSC", [
    'dojo/Deferred',
    'dojo/request',
    'dojo/promise/all',
    '../../webgis/Map',
    ...
    function SystemMapPSC(params, backFun) {
    ...
    SystemMapPSC.prototype.createLayer = function (list) {
    ...
    SystemMapPSC.prototype.getCurrentRule = function (rule) {
    ...
    SystemMapPSC.prototype.update = function (params) {
    ...
    SystemMapPSC.prototype.refresh = function () {
        this.view.clear();
        this.list = this.diagramVo.diagramVo.mapVo.layerVoList;
        this.createLayer(this.list);
    };

    SystemMapPSC.prototype.clear = function () {
        this.view.clear();

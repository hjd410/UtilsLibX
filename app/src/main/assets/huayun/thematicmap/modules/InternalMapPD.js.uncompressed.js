 ...
 */
define("com/huayun/thematicmap/modules/InternalMapPD", [
    "dojo/Deferred",
    "dojo/request",
    "dojo/promise/all",
    "../../webgis/Map",
    ...
    function InternalMapPD(params, backFun) {
    ...
    InternalMapPD.prototype.createLayer = function (list) {
        for (var i = list.length - 1; i > -1; i--) {
            ...
            aLayerVo.currentRule = this.getCurrentRule(aLayerVo.rules);//this.getCurrentRule(aLayerVo.rules);
    ...
    InternalMapPD.prototype.getCurrentRule = function (rule) {
    ...
    InternalMapPD.prototype.update = function (params) {
    ...
    InternalMapPD.prototype.refresh = function () {
        this.view.clear();
        this.list = this.diagramVo.diagramVo.mapVo.layerVoList;
        this.createLayer(this.list);
    };

    InternalMapPD.prototype.clear = function () {
        this.view.clear();
        this.view.threeRender();
    }
    return InternalMapPD;
});

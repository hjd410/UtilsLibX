define("com/huayun/thematicmap/modules/SystemMapDistrict", [
    'dojo/Deferred',
    'dojo/request',
    'dojo/promise/all',
    '../../webgis/Map',
    ...
    function SystemMapDistrict(params, backFun) {
        ...
        this.createLayer(params.diagramVo.diagramVo.mapVo.layerVoList);
    }

    SystemMapDistrict.prototype.createLayer = function (list) {
    ...
    SystemMapDistrict.prototype.getCurrentRule = function (rule) {
    ...
    SystemMapDistrict.prototype.update = function (params) {
    ...
    SystemMapDistrict.prototype.refresh = function () {
        this.view.clear();
        this.list = this.diagramVo.diagramVo.mapVo.layerVoList;
        this.createLayer(this.list);
    };

    SystemMapDistrict.prototype.clear = function () {
        this.view.clear();
        this.view.threeRender();
    }

    return SystemMapDistrict;
});

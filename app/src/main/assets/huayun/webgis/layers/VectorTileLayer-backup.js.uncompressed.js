 ...
 *  @Date:  2018/11/8
 *  @Desc: 矢量切片图层
 *  @see com.huayun.webgis.layers.VectaorHeatmapLayer
 */
define("com/huayun/webgis/layers/VectorTileLayer-backup", [
    // dojo包依赖
    "dojo/_base/declare",
    "dojo/topic",
    "dojo/request",
    ...
    return declare("com.huayun.webgis.layers.VectorTileLayer", [Layer], {
         ...
         * @param y 
         */
        intersectPoi: function (x, y) {
            var geometry = new Point2D(x, y);
            return this.layerView.intersectPoi([geometry]);
        }
    })
});
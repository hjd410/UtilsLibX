define("com/huayun/webgis/layers/support/StyleLayer", [
    ...
    "../../utils/image",
    "../../geometry/Point2D"
], function (f, FillBucket, LineBucket, SymbolBucket, FillExtrusionBucket, LineExtrusionBucket, HeatmapBucket, CircleBucket, Property, EvaluationParameters, expressions, utils, image, Point2D) {
...
// {layout?: Properties<...>, paint: Properties<...>}
    ...
    var LineExtrusionStyleLayer = (function (StyleLayer) {
        function LineExtrusionStyleLayer(layer) {
            StyleLayer.call(this, layer, properties$4);
        }

        if (StyleLayer) LineExtrusionStyleLayer.__proto__ = StyleLayer;
        LineExtrusionStyleLayer.prototype = Object.create(StyleLayer && StyleLayer.prototype);
        LineExtrusionStyleLayer.prototype.constructor = LineExtrusionStyleLayer;

        LineExtrusionStyleLayer.prototype.createBucket = function createBucket(parameters) {
            return new LineExtrusionBucket(parameters);
        };

        LineExtrusionStyleLayer.prototype.queryRadius = function queryRadius() {
            return translateDistance(this.paint.get('fill-extrusion-translate'));
        };

        LineExtrusionStyleLayer.prototype.is3D = function is3D() {
            return true;
        };

        LineExtrusionStyleLayer.prototype.queryIntersectsFeature = function queryIntersectsFeature(queryGeometry, feature, featureState, geometry,
                                                                                                   zoom, transform, pixelsToTileUnits, pixelPosMatrix) {
        ...
        return LineExtrusionStyleLayer;
    }(e));
    f.LineExtrusionStyleLayer = LineExtrusionStyleLayer;

define("com/huayun/webgis/layers/support/SourceCache", [
    "./TileSource",
    "./funcUtils",
    "./TileCache",
    "./Tile",
    ...
    SourceCache.prototype.prepare = function prepare(context) {
        ...
        for (var i in this._tiles) {
            ...
            tile.upload(context);
            tile.prepare(this.layer.imageManager);
        }
    };
    ...
    SourceCache.prototype._updateRetainedTiles = function _updateRetainedTiles(idealTileIDs, zoom) {
        ...
        for (var i = 0, list = idealTileIDs; i < list.length; i += 1) {
            // for (var i = 3, list = idealTileIDs; i < 4; i += 1) {
            var tileID = list[i];
        ...
        for (var i$1 = 0, list$1 = idealTileIDs; i$1 < list$1.length; i$1 += 1) {
            // for (var i$1 = 3, list$1 = idealTileIDs; i$1 < 4; i$1 += 1) {
            var tileID$1 = list$1[i$1];
     ...
     */
    SourceCache.prototype.tilesIn = function tilesIn(pointQueryGeometry, maxPitchScaleFactor, has3DLayer, resolution, zoom) {
        var this$1 = this;
        ...
        var tileSpaceQueryGeometry = [{
            ...
            y: Constant.layout.EXTENT * deltaY
        }];

define("com/huayun/webgis/layers/TerrainLayer", [
    "dojo/topic",
    "./Layer",
    "../views/3d/layers/TerrainLayerView3D",
    "../geometry/Extent",
    "../geometry/Point",
    "./support/TerrainSourceCacheHyTerrain",
    "./support/LOD",
    "./support/TileInfo",
    ...
    TerrainLayer.prototype._load = function (view) {
        ...
        serverUrl = require.toUrl("com/huayun/webgis/layers/support/tileInfoData2385.json");
    ...
    TerrainLayer.prototype.setUrl = function (url) {
        this.imageUrl = url;
        var ids = this.sourceCache.getIds();
        this.sourceCache.clearOtherLevel(this.layerView.view.viewpoint.level);
        for (var i = 0, list = ids; i < list.length; i += 1) {
            var tileID = list[i];
            this.sourceCache._reAddTile(tileID);
        }
    };

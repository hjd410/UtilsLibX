define("com/huayun/webgis/renderer/MultileadLineRenderer", [
    "./Renderer",
    "./LineRenderer",
    "./FontRenderer",
    "./RectRenderer"
], function (Renderer, LineRenderer, FontRenderer, RectRenderer) {
    function MultileadLineRenderer() {
    ...
    if (Renderer) MultileadLineRenderer.__proto__ = Renderer;
    MultileadLineRenderer.prototype = Object.create(Renderer && Renderer.prototype);
    MultileadLineRenderer.prototype.constructor = MultileadLineRenderer;

    MultileadLineRenderer.prototype.add = function (view, graphic, geometry, symbol, index) {
    ...
    MultileadLineRenderer.prototype.draw = function (view, graphic, geometry, symbol, layerView, index) {
        if (!index) index = 0;
    ...
    MultileadLineRenderer.prototype.drawGlow = function (view, graphic, geometry, symbol, layerView, index) {
        if (!index) index = 0;
    ...
    MultileadLineRenderer.prototype.calculateExtent = function (view, graphic, geometry, symbol, result, index) {
        if (!index) index = 0;

define("com/huayun/webgis/gl/TinySDF", [], function () {
    ...
    TinySDF.prototype.draw = function (achar) {
        this.ctx.clearRect(0, 0, this.size, this.size);
        this.ctx.fillText(achar, this.buffer, this.middle);
    ...
    TinySDF.prototype.measureText = function (achar) {
        return this.ctx.measureText(achar);
    };

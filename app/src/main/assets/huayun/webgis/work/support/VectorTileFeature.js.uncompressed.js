/**
 * mapbox封装的矢量切片图形类
 * @see com.huayun.webgis.work.support.VectorTileFeature
 */
define("com/huayun/webgis/work/support/VectorTileFeature", [
    "../../geometry/Point"
], function (Point) {
     ...
     * @ignore
     * @private
     * @alias com.huayun.webgis.work.support.VectorTileFeature
     * @param pbf
     * @param end
     * @param extent
     * @param keys

define(
  "com/huayun/webgis/views/3d/layers/GraphicLayerView3DOld", [
    "dojo/_base/declare",
    "../GraphicsView",
    "./LayerView3D",
    ...
    return declare("com.huayun.webgis.views.3d.layers.GraphicLayerView3DOld", [LayerView3D], {
      ...
      _render: function () {
        if (this.visible) {
          ...
          for (var i = 0; i < graphics.length; i++) {
            graphic = graphics[i];
            if (graphic.glow && graphic.visible) {

define("com/huayun/webgis/views/3d/layers/EditGraphicLayerView3D", [
    ...
    return declare("com.huayun.webgis.views.3d.layers.EditGraphicLayerView3D", [LayerView3D], {
            ...
            if (this.visible) {
                ...
                for (var i = 0; i < graphics.length; i++) {
                    ...
                    if (graphic.visible) {
                        ...
                        if (symbol) {
                            this.renderer.draw(this, graphic, graphic.feature.geometry, symbol);
                        }
                    }
                }
            }
        ...
        addGraphic: function (graphic) {
            ...
            if (graphic.symbol) {
                graphic.added = true;
                this.renderer.add(this, graphic, graphic.feature.geometry, graphic.symbol);
            }
        },
